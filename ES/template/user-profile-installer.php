...
<head>
    ...
    <title>Perfil de Instaladores</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="ventana-confirmacion" style="display: none;">
        ...
        <link rel="stylesheet" type="text/css" href="../bower_components/sweetalert/css/sweetalert.css">
                    ...
                    </div><div class="sa-icon sa-custom" style="display: none;"></div><h2>¿Quieres realizar esta acción?</h2>
                    <p style="display: block;">Si hace clic en aceptar, los cambios no se pueden revertir.</p>
                    <fieldset>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-sm-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Perfil de Instalador</h4>
                                                        <span>Toda la información del Instalador está en este perfil</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                                ...
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            ...
                                                                            <span class="text-white">Instalador</span>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                    ...
                                                    <div class="tab-pane active" id="personal" role="tabpanel">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header"  style="display: flex; justify-content: space-between; align-items: center;">
                                                                <h5 class="card-header-text">Información del Instalador</h5>
                                                                                    ...
                                                                                    <div class="table-responsive">
                                                                                        <table class="table">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <th scope="row">Teléfono móvil</th>
                                                                                                    <td><?php echo $res[0]["Teléfono móvil"]; ?></td>
                                                                                                </tr>  
                                                                                                <tr>
