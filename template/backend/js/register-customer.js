            ...
            if(cl_51.value == 'si')
            {
                    ...
                    )
                {
                        ...
                        )
                    {
                        ...
                        request.send(`cl_1=${cl_1.value.trim()} & cl_2=${cl_2.value.trim()} & cl_3=${cl_3.value.trim()} & cl_4=${cl_4.value.trim()} & cl_5=${cl_5.value.trim()} & cl_6=${cl_6.value.trim()} & cl_8=${cl_8.value.trim()} & cl_9=${cl_9.value.trim()} & cl_10=${cl_10.value.trim()} & cl_11=${cl_11.value.trim()} &cl_12=${cl_12.value.trim()} &cl_13=${cl_13.value.trim()} &cl_14=${cl_14.value.trim()} & cl_15=${cl_15.value.trim()} & cl_16=${cl_16.value.trim()} & cl_17=${cl_17.value.trim()} & cl_18=${cl_18.value.trim()} & cl_19=${cl_19.value.trim()} & cl_20=${cl_20.value.trim()} & cl_21=${cl_21.value.trim()} & cl_22=${cl_22.value.trim()} & cl_23=${cl_23.value.trim()} & cl_24=${cl_24.value.trim()} & cl_25=${cl_25.value.trim()} & cl_26=${cl_26.value.trim()} &cl_27=${cl_27.value.trim()} & cl_28=${cl_28.value.trim()} & cl_29=${cl_29.value.trim()} & cl_30=${cl_30.value.trim()} & cl_31=${cl_31.value.trim()} & cl_32=${cl_32.value.trim()} & cl_33=${cl_33.value.trim()} & cl_34=${cl_34.value.trim()} & cl_35=${cl_35.value.trim()} & cl_36=${cl_36.value.trim()} & cl_37=${cl_37.value.trim()} & cl_38=${cl_38.value.trim()} & cl_39=${cl_39.value.trim()} & cl_40=${cl_40.value.trim()} & cl_41=${cl_41.value.trim()} & cl_42=${cl_42.value.trim()} & cl_43=${cl_43.value.trim()} & cl_44=${cl_44.value.trim()} & cl_45=${cl_45.value.trim()} & cl_46=${cl_46.value.trim()} & cl_47=${cl_47.value.trim()} & cl_48=${cl_48.value.trim()} & cl_49=${cl_49.value.trim()} & cl_50=${cl_50.value.trim()} & cl_51=${cl_51.value.trim()} & cl_cantidad_financiada=${cl_cantidad_financiada.value.trim()} & cl_nombre_representante=${cl_nombre_representante.value.trim()} & avatar_selected=${avatar_selected.trim()} & co_1=${co_1.value} & co_2=${co_2.value} & co_3=${co_3.value} & co_4=${co_4.value} & co_5=${co_5.value} & co_6=${co_6.value} & co_7=${co_7.value}& co_9=${co_9.value} & co_10=${co_10.value} & co_11=${co_11.value} & co_12=${co_12.value} & co_13=${co_13.value} & co_14=${co_14.value} & co_15=${co_15.value} & co_16=${co_16.value} & co_17=${co_17.value} & co_18=${co_18.value} & co_19=${co_19.value} & co_20=${co_20.value} & co_21=${co_21.value} & co_22=${co_22.value} & co_23=${co_23.value} & co_24=${co_24.value} & co_25=${co_25.value} & co_26=${co_26.value} & co_27=${co_27.value} & co_28=${co_28.value} & co_29=${co_29.value} & co_30=${co_30.value} & co_31=${co_31.value} & co_32=${co_32.value} & co_33=${co_33.value} & co_34=${co_34.value} & co_35=${co_35.value} & co_36=${co_36.value}`)
                    }
                    else
                    {
                        // Funcion para hacer aparecer la ventana de notificacion
                ...
                request.onreadystatechange = function () {
                    ...
                    if (request.readyState == 4 && request.status == 200) {
                        ...
                        if(request.responseText == "status:Correct - status:Correct" || request.responseText == "status:Correct - status:none")
                            ...
                            {
                                let msg = request.responseText.split('-')
                                msg = msg[0]
