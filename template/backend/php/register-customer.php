<?php
    ...
    if(!empty($_POST))
    {
        ...
        if($rol == "2")
        {
            ...
            {
                if($item["Id"] == $cl_nombre_representante)
                {
                    $con_i = true;
                }
            }
        ...
        {
            if($cl_nombre_representante == $id_logued)
            {
                $con_i = true;
            }
        }
